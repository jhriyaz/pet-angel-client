import {
  ...
  const PetListing = () => {
    ...
    const handleCategory = (event) => {
      ...
      navigate(`/pet-listing/${event.target.value}`)
    };
    ...
    <Typography variant="h3" sx={{textAlign:'center',paddingTop:3}}>
    no pets From {category}
    </Typography>
    </Container> :items.map((pet) =><PetCardStyle key={pet._id} pet={pet}></PetCardStyle>
              )}
             </Grid>
           }
            <Grid
